...
export const UserManagement: React.FC = () => {
  ...
  const filterUsers = () => {
    ...
    if (filterBranch !== 'all') {
      filtered = filtered.filter(user =>
        user.employmentBranch === filterBranch
      );
    }
  ...
  const handleEdit = (user: UserProfile) => {
    ...
    setFormData({
      ...
      employmentMaritalStatus: user.employmentMaritalStatus || '',
      employmentBranch: user.employmentBranch || '',
      employmentTeam: user.employmentTeam || '',
      employmentSalaryPercentage: user.employmentSalaryPercentage || 100,
      employmentActive: typeof user.employmentActive === 'boolean' ? user.employmentActive : true,
    });
    setShowModal(true);
  };
